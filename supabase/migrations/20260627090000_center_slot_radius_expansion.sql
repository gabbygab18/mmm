-- Sprint 5 follow-up: center-side radius expansion for musician availability slot discovery

CREATE OR REPLACE FUNCTION public.get_nearby_musician_availability_slots_for_center_with_expansion(
...
GRANT EXECUTE ON FUNCTION public.get_nearby_musician_availability_slots_for_center_with_expansion(UUID, INTEGER, INTEGER, INTEGER) TO authenticated;
