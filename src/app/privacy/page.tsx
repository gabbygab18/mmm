  ...
  return (
    <main className="bg-ocean-900 font-sans">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 sm:px-8">
        <h1 className="font-garamond text-[32px] font-bold text-white">Privacy Policy</h1>
        ...
        <div className="prose prose-invert mt-8 max-w-none font-poppins text-[14px] leading-relaxed text-white/90">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Who we are</h2>
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">What information we collect</h2>
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">How we use your information</h2>
            <ul className="mt-3 space-y-1.5 pl-5 leading-relaxed list-disc">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Who can see your information</h2>
            <ul className="mt-3 space-y-1.5 pl-5 leading-relaxed list-disc">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Email notifications</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Data retention</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Your rights</h2>
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Cookies and local storage</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Children</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="mt-8">
            <h2 className="font-garamond text-[20px] font-bold text-white">Changes to this policy</h2>
            <p className="mt-3 leading-relaxed">
        ...
        <div className="mt-12 border-t border-white/20 pt-6">
          <Link href="/terms" className="font-poppins text-[13px] font-medium text-white underline-offset-2 hover:underline">
