    ...
    <main className="bg-ocean-900 font-sans">
      ...
      <div className="bg-[#faf4e7]">
        <div className="mx-auto max-w-3xl px-6 py-12 sm:px-8">
          <h1 className="font-garamond text-[32px] font-bold text-ocean-900">Privacy Policy</h1>
          ...
          <div className="prose prose-stone mt-8 max-w-none font-poppins text-[14px] leading-relaxed text-ocean-900/90">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Who we are</h2>
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">What information we collect</h2>
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">How we use your information</h2>
              <ul className="mt-3 space-y-1.5 pl-5 leading-relaxed list-disc">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Who can see your information</h2>
              <ul className="mt-3 space-y-1.5 pl-5 leading-relaxed list-disc">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Email notifications</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Data retention</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Your rights</h2>
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Cookies and local storage</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Children</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Changes to this policy</h2>
              <p className="mt-3 leading-relaxed">
          ...
          <div className="mt-12 border-t border-ocean-200 pt-6">
            <Link href="/terms" className="font-poppins text-[13px] font-medium text-ocean-700 hover:text-ocean-800">
