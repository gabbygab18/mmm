...
function SectionCard({ children, className = '' }: { children: React.ReactNode; className?: string }) {
  return (
    <div
      className={`rounded-2xl px-7 py-8 shadow-xl sm:px-10 ${className}`}
  ...
  return (
    <main className="bg-ocean-900 font-sans">
      ...
      <section className="relative overflow-hidden">
        ...
        />
        <div
          className="absolute inset-y-0 right-0 hidden w-1/2 bg-cover bg-left md:block"
          style={{
        ...
        <div className="relative mx-auto max-w-[1150px] px-6 py-16 sm:px-8">
          <h1 className="landing-rise max-w-[720px] font-garamond text-[42px] font-semibold leading-tight text-white drop-shadow-md sm:text-[56px] lg:text-[65.9px]">
            First-Time Education
          </h1>
          <p className="landing-rise landing-delay-1 mt-4 max-w-[560px] font-poppins text-[15px] leading-relaxed text-ocean-950 sm:text-[19.5px]">
      ...
      >
        <div className="mx-auto max-w-[1150px] space-y-8 px-5 py-12 sm:px-8">
          {/* 1. What We Do */}
          <SectionCard>
            ...
            <div className="mt-6 grid gap-10 md:grid-cols-2">
              <div className="flex items-start gap-5">
                ...
                <img src="/mmm/icon-mission.png" alt="" className="h-24 w-24 shrink-0 object-contain" />
                <div>
              ...
              <div className="flex items-start gap-5">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/mmm/icon-vision.png" alt="" className="h-24 w-24 shrink-0 object-contain" />
                <div>
          ...
          <SectionCard>
            <div className="grid gap-8 md:grid-cols-[1.2fr_1fr]">
              ...
              <div className="relative min-h-[240px] overflow-hidden rounded-xl">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/mmm/edu-quote.png" alt="" className="absolute inset-0 h-full w-full object-cover" />
                <div className="absolute inset-0 bg-white/55" aria-hidden="true" />
                <div className="relative flex h-full flex-col items-center justify-center px-8 py-10 text-center">
                  <span aria-hidden="true" className="font-garamond text-[64px] leading-none text-ocean-300">
                    &ldquo;
                  </span>
                  <p className="-mt-4 font-garamond text-[26px] font-bold leading-snug text-ocean-900 sm:text-[30.2px]">
                    When words fail,
                    <br />
                    music speaks.
                  </p>
        ...
        {/* ============ Your almost ready ============ */}
        <div className="mx-auto flex max-w-[1150px] flex-col items-center gap-8 px-6 pb-16 sm:px-8 lg:flex-row lg:justify-between">
          <div className="flex items-center gap-6">
            <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-full bg-ocean-300/40">
              <svg className="h-14 w-14 text-ocean-950" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
