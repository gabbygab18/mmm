    ...
    <main className="bg-ocean-900 font-sans">
      ...
      <div className="bg-[#faf4e7]">
        <div className="mx-auto max-w-3xl px-6 py-12 sm:px-8">
          <h1 className="font-garamond text-[32px] font-bold text-ocean-900">Terms of Service</h1>
          <p className="mt-2 font-poppins text-[12px] text-ocean-900/60">Last updated: June 28, 2026</p>

          <div className="prose prose-stone mt-8 max-w-none font-poppins text-[14px] leading-relaxed text-ocean-900/90">

            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">About this platform</h2>
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Volunteer-only model</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Eligibility and accounts</h2>
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Acceptable use</h2>
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Scheduling and commitments</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Content and photos</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Safety and liability</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Account termination</h2>
              <p className="mt-3 leading-relaxed">
              ...
              <p className="mt-3 leading-relaxed">
                Upon deletion, your personal profile information will be removed or anonymized per our <Link href="/privacy" className="font-medium text-ocean-700 underline">Privacy Policy</Link>. Anonymized records of completed events may be retained.
              </p>
            </section>

            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Disclaimers</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Changes to these Terms</h2>
              <p className="mt-3 leading-relaxed">
            ...
            <section className="mt-8">
              <h2 className="font-garamond text-[20px] font-bold text-ocean-900">Contact</h2>
              <p className="mt-3 leading-relaxed">
                Questions about these Terms:{' '}
                <a href="mailto:privacy@margaretsmemorycaremusic.com" className="font-medium text-ocean-700 underline">
          ...
          <div className="mt-12 border-t border-ocean-200 pt-6">
            <Link href="/privacy" className="font-poppins text-[13px] font-medium text-ocean-700 hover:text-ocean-800">
              View Privacy Policy →
            </Link>
          </div>
        </div>
