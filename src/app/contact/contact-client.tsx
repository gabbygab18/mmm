      ...
      <section className="relative isolate">
        ...
        <div className="mx-auto grid max-w-[1200px] items-start gap-10 px-5 pb-14 pt-9 sm:px-8 sm:pb-16 sm:pt-12 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:gap-16 lg:pt-14">
          ...
          <div className="lg:pt-8">
            <h2 className="text-center font-garamond text-[26px] font-bold text-white sm:text-[34px] lg:text-[45px]">{t('contact.touch.title')}</h2>
            <p className="mx-auto mt-2 max-w-[420px] text-center font-poppins text-[13.5px] leading-snug text-white sm:text-[17px] lg:text-[21.1px]">
              <Lines text={t('contact.touch.body')} />
            </p>

            {/* E-mail only for now — the inbox is live, the phone number is not
                (the old card carried a placeholder), so that one stays out. */}
        ...
        <div className="mx-auto max-w-[1200px] px-6 sm:px-8">
          ...
          >
            <div className="px-6 py-8 sm:px-10 sm:py-10 lg:px-12">
              <h2 className="font-garamond text-[24px] font-bold text-ocean-900 sm:text-[34px] lg:text-[45px]">{t('contact.location.title')}</h2>
              <p className="mt-3 max-w-[420px] font-poppins text-[13.5px] leading-relaxed text-ocean-900 sm:text-[14.9px]">
                <Lines text={t('contact.location.body')} />
              </p>
